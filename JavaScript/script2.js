...
// MOD: ball size has been increased and so has the incrementedSpeed)
var Ball = {
...
var Game = {
  ...
  draw: function () {
    ...
    // Set the fill style to gold(edited from white in the original code) (For the paddles and the ball)
    this.context.fillStyle = "#D3CF03";
    ...
    this.context.strokeStyle = "AAE88A";
    this.context.stroke();
