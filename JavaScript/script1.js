//Pong game project 1: This work leans heavily on a tutorial by Devression on youtube, available at: https://www.youtube.com/watch?v=jrqN0uZwhwk[accessed on July 26nd 2023]
//Global variables
var DIRECTION = {
  IDLE: 0,
  UP: 1,
...
var colors = ["#fa89f1", "#282429", "#2f0396", "#08f7ff", "#ffffff"];
...
var Game = {
  ...
  endGameMenu: function (text) {
    // New canvas font size and color
  ...
  draw: function () {
    ...
    //Default font and its placement
  ...
  loop: function () {
    ...
    // Check if the game have finished, else draw a new frame
    if (!Pong.over) requestAnimationFrame(Pong.loop);
  },

  listen: function () {
    document.addEventListener("keydown", function (key) {
      //"Press key to begin" action
